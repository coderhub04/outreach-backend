...
const { createForum, getForums, getForum, joinForum, leaveForum, createForumPost, getForumPost, addLikeOnForumFeedController, deleteForumPost, updateForumPost } = require('../controllers/ForumController');
...
router.patch("/forum-post/update/:feedId", decryptFirebaseToken, updateForumPost);
